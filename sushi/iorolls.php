...
global $filiale;
$table = 'insideoutrolls'; // Corresponding table name
...
// Fetch bowls items
$sql = "SELECT * FROM insideoutrolls ORDER BY artikelnummer ASC";
...
<head>
    ...
    <title>Digitale Speisekarte - Insideoutrolls</title>
