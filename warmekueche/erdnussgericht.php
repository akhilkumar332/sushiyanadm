...
global $filiale;
$table = 'erdnussgericht'; // Corresponding table name
...
// Fetch bowls items
$sql = "SELECT * FROM erdnussgericht ORDER BY artikelnummer ASC";
...
<head>
    ...
    <title>Digitale Speisekarte - Erdnussgericht</title>
