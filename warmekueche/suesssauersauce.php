...
global $filiale;
$table = 'suesssauersauce'; // Corresponding table name
...
// Fetch bowls items
$sql = "SELECT * FROM suesssauersauce ORDER BY artikelnummer ASC";
...
<head>
    ...
    <title>Digitale Speisekarte - Suesssauersauce</title>
