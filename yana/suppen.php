...
if (!isset($_SESSION['cart'])) {
    $_SESSION['cart'] = [];
    // Use JavaScript to POST the cart data to restore_cart.php
    echo "<script>
        if (localStorage.getItem('cart')) {
            ...
            .then(data => {
                ...
                // Optionally update cart count without reload
                updateCartCount();
            })
...
// Fetch suppen items
$sql = "SELECT * FROM suppen ORDER BY artikelnummer ASC";
...
<head>
    ...
    <title>Digitale Speisekarte - Suppen</title>
