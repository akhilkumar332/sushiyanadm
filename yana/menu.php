...
$categories = [
    'suppen' => 'Suppen',
    'fingerfood' => 'Vorspeise',
    'gyoza' => 'Gyoza',
    'salate' => 'Salat',
    'sommerrollen' => 'Sommerrolle',
    'bowls' => 'Bowl',
    'desserts' => 'Dessert',
    'extras' => 'Extras',
    'getraenke' => 'Getränke',
    'warmgetraenke' => 'Warme Getränke',
];
...
<body class="artikelliste" data-page="yana_menu" data-base-path="<?php echo BASE_PATH; ?>" data-session-cart="<?php echo htmlspecialchars(json_encode($_SESSION['cart'])); ?>" data-table="<?php echo htmlspecialchars($table); ?>">
    <header>
